...
/* package lambdaIR-0.1.0.0 */
#ifndef VERSION_lambdaIR
#define VERSION_lambdaIR "0.1.0.0"
#endif /* VERSION_lambdaIR */
#ifndef MIN_VERSION_lambdaIR
#define MIN_VERSION_lambdaIR(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_lambdaIR */
...
#define CURRENT_COMPONENT_ID "lambdaIR-0.1.0.0-inplace-lambdaIR"
